...
fun PauseScreenContent(
    ...
    Column(modifier = Modifier.background(MaterialTheme.colors.secondary)) {
        ...
        WorkTimer(
            time = state.time,
            title = stringResource(id = R.string.time_pause),
...
@Preview(locale = "ru")
@Composable
private fun DinneringPrev() {
    WorkTrackerTheme {
        DinneringScreenContent(
